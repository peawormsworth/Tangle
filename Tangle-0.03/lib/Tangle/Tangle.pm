...
sub x_gate   { my $m = shift; $m->_gate((ref $m)->new(  0,  1 ) / $m) }
sub y_gate   { my $m = shift; $m->_gate((ref $m)->new(  0, -1 ) / $m) }
sub z_gate   { my $m = shift; $m->_gate((ref $m)->new( -1,  0 ) / $m) }
sub i_gate   { my $m = shift; $m->_gate((ref $m)->new(  1,  0 ) / $m) }
sub hadamard { my $m = shift; $m->_gate((ref $m)->new( HR, HR ) / $m) }
